...
//SSD1306 OLED update loop
	...
	static void print_logo_narrow(void) {
		...
		#ifdef OLED_LOGO
			render_logo(0,10); //Not defining this in config.h will save 112 bytes.
		#endif
	}
...
//		        rgblight_sethsv(50, 100, 200);
                break;
		    case 1:
		        oled_write("1    ", false);
//		        rgblight_sethsv(0, 100, 200);
                break;
            case 2:
                oled_write("2    ", false);
//                rgblight_sethsv(150, 100, 200);
                break;
            case 3:
...
//		oled_write("Num", !(led_usb_state.num_lock));
		oled_set_cursor(0,8);
		oled_write(" Rus ", led_usb_state.scroll_lock);
